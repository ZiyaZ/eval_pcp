...
;+
; Get accumulated hourly HRRR total precipitation as generated by the
...
; Sample layer names:
;
; "Scaled CHR non-snow precipitation 3hr 2018-01-02 12"
; "Scaled CHR snow precipitation 3hr 2018-01-02 12"
;-
...
;-
      nonSnowLayer = 'Scaled CHR non-snow precipitation ' + $
...
;-
          snowLayer = 'Scaled CHR snow precipitation ' + $
                      STRCRA(TargetFcstHour) + 'hr ' + $
                      cycleDate_GISRS
